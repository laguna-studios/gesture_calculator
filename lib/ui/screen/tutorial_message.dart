...
class TutorialMessage extends StatelessWidget {
  ...
  const TutorialMessage(
      {super.key, required this.child, required this.tutorialStep, required this.callback, this.skipToStep});
      ...
      listener: (context, state) => showDialog(
          ...
          builder: (dialogContext) => WillPopScope(
                ...
                child: AlertDialog(
                  ...
                  content: Text(FlutterI18n.translate(context, "tutorial.step$tutorialStep.message"),
                      style: TextStyle(color: Theme.of(context).extension<CalculatorTheme>()!.drawerText)),
